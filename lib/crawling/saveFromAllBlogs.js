...
var itemFromBlogRssEntry = require("./itemFromArticleDescription.js");
var getItemFromRssEntryPost = require("./getItemFromArticleLink.js");
...
function saveFromBlogs(blogs, entryHandler, cb) {
  function saveFromBlog(index) {
    if (index < blogs.length) {
      ...
      crawlBlogRss(
        'https://' + blogs[index] + '.blogspot.com/atom.xml?max-results=65536',
        entryHandler,
        function(){
